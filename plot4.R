...
par(mfrow=c(2,2))
plot(data2$datetime,as.numeric(data2$Global_active_power),type="l",xlab="",ylab="Global Active Power")
plot(data2$datetime,as.numeric(data2$Voltage),type="l",xlab="datetime",ylab="Voltage")
...
plot(data2$datetime,as.numeric(data2$Global_reactive_power),type="l",xlab="datetime",ylab="Global_reactive_power")
